...
export default function Home({ settings, services }: HomeClientProps) {
  ...
  const featuredServices = [
    ...
    },
    {
      ...
      description: 'A tailored lesson focused on techniques, product placement, and a finished look you can recreate confidently.',
      startingPrice: 'Custom quote',
      duration: '2 hrs',
      bestFor: 'Clients who want to improve everyday makeup, refine technique, or build a personal routine.',
      ctaLabel: 'Ask about lessons',
      href: '/contact?service=1%3A1%20Makeup%20Lesson',
    },
    {
