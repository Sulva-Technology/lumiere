  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
      <Glass level="heavy" className="p-8 sm:p-12 text-center">
        ...
        <h1 className="mt-4 font-serif text-4xl text-[#4A2109] sm:text-5xl">Track Your Order</h1>
        ...
        <Link
          href="/contact"
          className="mt-8 inline-flex rounded-full bg-[#8B4411] px-6 py-3 font-medium text-white transition-opacity hover:opacity-90"
        >
          Contact Support
        </Link>
      </Glass>
