  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      <Glass level="heavy" className="p-8 sm:p-12">
        ...
        <h1 className="mt-4 font-serif text-4xl text-[#1A1008] dark:text-white sm:text-5xl">{title}</h1>
      ...
      <div className="mt-8 space-y-6">
        {sections.map((section) => (
          <Glass key={section.title} level="medium" className="p-6 sm:p-8">
            <h2 className="font-serif text-2xl text-[#1A1008] dark:text-white">{section.title}</h2>
